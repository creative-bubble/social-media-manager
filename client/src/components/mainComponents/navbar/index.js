    ...
    return(
        <div className="container-xl bg-gray-900">
                <div className="fixed w-full h-20 pt-4 text-gray-300 bg-gray-900 z-10 flex flex-row sm:justify-center sm:relative sm:w-9/12 sm:mx-auto">
                        ...
                        <button className="fixed right-0 top-0 mt-4 mx-4 z-10 sm:hidden border border-blue-500 text-blue-500 w-8 h-8 hover:bg-blue-500 hover:text-gray-200 focus:outline-none"
                                onClick={toggleNav}>
                                {isOpenNav
                                   ?
